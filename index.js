...
// The internal variable is defined within myFunction. So, when you have another function, nestedFunction, within my function, you can access internal within nested function (it's within scope).
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(animals){
    ...
    animals.forEach((animal)=> {
      ...
      let animalFullName = `name: ${name}, scientific: ${scientific}`;

      displayNames.push(animalFullName);
  ...
  */
  ...
  function lowerCaseNames(animalLC){
    return animalLC.map((animal)=>{
  ...
  */
  ...
  function lowPopulationAnimals(animalsArray){
    return animalsArray.filter((animals)=>{
      let lessPop = animals.population < 5;
      return lessPop;
    });
  }
  ...
  */
  ...
  function USApop(zooAnimalArray){
    return zooAnimalArray.reduce((currentTotalSum, animal)=> {
      let sum = currentTotalSum+animal.population;
      return sum;
    }, 0);
  }
